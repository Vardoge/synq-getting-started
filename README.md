 ...
 * __Be Consistent__ - follow [conventions](http://www.phoenixframework.org/), [standards](https://en.wikipedia.org/wiki/Representational_state_transfer), style guides are all good things, as it makes it easier to collaborate with teammates and allows us to execute faster as we follow well known systems and frameworks
